<?php
    ...
    $tugas = mysqli_query($konek, "SELECT * FROM guru WHERE status = 'enable' AND kelas IN ('X','XI', 'XII') ");
     ...
     <nav class="sidebar navbar bg-dark navbar-dark w-25  d-flex flex-column p-3 h-100">
        ...
        <div id="sidebarMenu" class="collapse d-md-block w-100">
            ...
            <div class="button d-flex flex-column my-4 gap-5">
                <a href="../formGuru/tableGuru.php" class="btn btn-info btn-lg"><i class="bi bi-house-dash"></i>Home</a>
                <a href="../LaporanMasalah/formPesan.php" class="nav-link text-light">Cek Pesanan</a>
                <a href="#" class="nav-link text-light">Lihat Masalah</a>
                <a href="#" class="nav-link text-light">Status</a>
            </div>
...
<div class="container-fluid mt-4">
    <table class="table table-bordered bg-light text-dark w-screen">
        ...
        <tr>
            ...
            <td><?=$data['kelas'] ?></td>
            <td><?=$data['tanggal'] ?></td>
            <td><a href="../formGuru/inputanGuru/server/<?=$data['file'] ?>">download</a></td>
        </tr>
