...
if(!isset($_SESSION['next'])){
    ...
    $masuk = mysqli_query($konek, "SELECT * FROM table_siswa WHERE nis = '$khusus' AND kelas IN('XII')");
    
    $tugas = mysqli_query($konek, "SELECT * FROM guru WHERE status = 'enable' AND kelas IN ('XII') ");
    ...
    window.location.href='klsXII.php'
    </script>";
    }
...
<body class="bg bg-secondary">
     <nav class="sidebar navbar bg-dark navbar-dark w-25  d-flex flex-column p-3 h-100">
        ...
        <div id="sidebarMenu" class="collapse d-md-block w-100">
            ...
            <div class="button d-flex flex-column my-4 gap-5">
                <a href="klsXII.php" class="btn btn-secondary btn-lg"><i class="bi bi-house-dash"></i>Home</a>
                <a href="./kelas12/tugasKlsXII.php" class="btn btn-outline-secondary text-light">Cek Tugas Yang diupload</a>
                <a href="./kelas12/tugasGuru.php" class="btn btn-outline-secondary text-light">Lihat Tugas atau Ujian</a>
                <a href="./kelas12/dokumen.php" class="btn btn-outline-secondary text-light">Lihat Dokumen</a>
    ...
    <div class="alert d-flex flex-row justify-content-evenly gap-5" role="alert">
      <strong class="fs-1 text-light bg-secondary rounded-2 w-75 text-center">Tabel mSiswa Kelas XII</strong>
